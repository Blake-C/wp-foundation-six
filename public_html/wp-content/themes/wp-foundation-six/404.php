		...
		<main class="medium-8 columns" id="content">
			...
			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'wp_foundation_six' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					<?php
						...
						$wpfs_archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'wp_foundation_six' ), convert_smilies( ':)' ) ) . '</p>';
						the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$wpfs_archive_content" );
					?>
